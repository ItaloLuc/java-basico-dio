package edu.italo.segundasemana.Escopo;

public class Escopo {
    /*O escopode pode ser entendido como ambiente onde uma variável pode ser acessada. 
    Em Java, o escopo de variáveis vai de acordo como bloco onde ela foi declarada. */
    ...
    Em uma Classe, podemos visualizar a diferença de escopos. 
